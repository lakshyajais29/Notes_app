...
class AddNoteFragment : Fragment(R.layout.fragment_add_note),MenuProvider {
    ...
    override fun onCreateView(
        ...
        addNoteBinding = FragmentAddNoteBinding.inflate(R.layout.fragment_add_note, container, false)
        return binding.root
    }
    ...
    private fun saveNote(view: View){
        ...
        if(noteTitle.isNotEmpty()){
            ...
            Toast.makeText(addNoteView.context,"enter note title",Toast.LENGTH_SHORT).show()
        }
    }
